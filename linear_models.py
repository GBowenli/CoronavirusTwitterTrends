...
twitter_text = numpy.concatenate((df_pos[0:10000], df_neg[0:10000]), axis=0)
twitter_cat = numpy.concatenate((numpy.ones(10000), numpy.zeros(10000)), axis=0)
...
for train_index, test_index in kf.split(twitter_text):
    ...
    clf.fit(vectors_train, twitter_cat[train_index])
